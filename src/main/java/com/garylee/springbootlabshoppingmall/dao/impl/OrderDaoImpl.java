...
import com.garylee.springbootlabshoppingmall.rowmapper.OrderItemRowMapper;
import com.garylee.springbootlabshoppingmall.rowmapper.OrderRowMapper;
...
//       查詢條件
    ...
    private String addFilteringSql(String sql, HashMap<String, Object> map, OrderQueryParams orderQueryParams) {
